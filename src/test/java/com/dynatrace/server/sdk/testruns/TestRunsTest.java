...
import com.dynatrace.server.sdk.testruns.models.*;
...
public class TestRunsTest {
    ...
    private TestRuns testRuns = new TestRuns(new DynatraceClient(new BasicServerConfiguration("admin", "admin", false, "localhost", 8080, false)));

    @Test
    public void createTestRun() throws Exception {
        stubFor(post(urlPathEqualTo(String.format(TestRuns.TEST_RUNS_EP, "Test", "")))
        ...
        TestRun tr = this.testRuns.createTestRun(request);
    ...
    public void fetchTestRun() throws Exception {
        stubFor(get(urlPathEqualTo(String.format(TestRuns.TEST_RUNS_EP, "Test", "078e961b-9e6e-44ec-ab12-ab0d31be93fc")))
                .willReturn(aResponse()
                        .withStatus(200)
                        .withBody("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n" +
                                ...
                                "  </testResult>\n" +
                                "</testRun>")));
        TestRun tr = this.testRuns.fetchTestRun("Test", "078e961b-9e6e-44ec-ab12-ab0d31be93fc");
    ...
    public void fetchTestRuns() throws Exception {
        stubFor(get(urlPathEqualTo(String.format(TestRuns.TEST_RUNS_EP, "IntelliJ", ""))).withQueryParam("extend", equalTo("testRuns")).withQueryParam("category", equalTo("unit"))
                .willReturn(aResponse()
        ...
        com.dynatrace.server.sdk.testruns.models.TestRuns testRuns = this.testRuns.fetchTestRuns(request);
